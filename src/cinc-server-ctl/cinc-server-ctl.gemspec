...
Gem::Specification.new do |spec|
  ...
  # TODO
  # cinc-server-ctl server-admins commands dep, will be removed in server-admins V2
  ...
  spec.add_runtime_dependency "chef", "~> 15.8.23", source: "https://packagecloud.io/cinc-project/stable"
