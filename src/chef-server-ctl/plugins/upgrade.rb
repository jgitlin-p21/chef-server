...
add_command_under_category "upgrade", "general", "Upgrade your private chef installation.", 2 do
  ...
  def parse(args)
    ...
    @options.chef11_admin_client_key = "/etc/#{Chef::Dist::SERVER}/admin.pem"

    opt_parser = OptionParser.new do |opts|
      opts.banner = "Usage: #{Chef::Dist::SERVER_CTL} upgrade [options]"
  ...
  def detect_chef11
    ...
    File.directory?("/opt/#{Chef::Dist::SERVER}")
  end
