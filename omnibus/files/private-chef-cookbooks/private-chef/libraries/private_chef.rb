...
module PrivateChef
  ...
  class << self
    ...
    def migrate_keys
      did_something = add_key_from_file_if_present("#{Chef::Dist::SERVER}", 'superuser_key', '/etc/opscode/pivotal.pem')
      did_something |= add_key_from_file_if_present("#{Chef::Dist::SERVER}", 'webui_key', '/etc/opscode/webui_priv.pem')
